...

{
    ...
    services.nfs.server.exports = ''
      /mnt/storage-ssd/editing-workspace	haruka.local,haruka,saejima.local,saejima(rw,async,insecure,no_root_squash,no_subtree_check)
      /mnt/storage-ssd/editing-finished	        haruka.local,haruka,saejima.local,saejima(rw,async,insecure,no_root_squash,no_subtree_check)
      /mnt/storage-ssd/games	                haruka.local,haruka,saejima.local,saejima(rw,async,insecure,no_root_squash,no_subtree_check)
    '';
